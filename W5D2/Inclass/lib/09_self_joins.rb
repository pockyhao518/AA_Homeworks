...
def haymarket_and_leith
  ...
  from routes as r1
  inner join routes as r2 on (r1.company = r2.company AND r1.num = r2.num)
...
def craiglockhart_and_tollcross
  ...
  from routes as r1
  inner join routes as r2 on (r1.company = r2.company AND r1.num = r2.num)
  inner join stops as a on (r1.stop_id = a.id)
  inner join stops as b on (r2.stop_id = b.id)
...
def start_at_craiglockhart
  ...
  execute(<<-SQL)
  select distinct b.name, r2.company, r2.num
  from routes as r1
  inner join routes as r2 on (r1.company = r2.company AND r1.num = r2.num)
  inner join stops as a on (r1.stop_id = a.id)
  inner join stops as b on (r2.stop_id = b.id)
